...
(iii) The degeneracy at the nearest high-symmetry k-points to the VBM(CBM) is not 2.
...
## Ouput
A json file will be saved which contains the following results:
...
3. The "nearest high-symmetry k-points" to the VBM(CBM) refers to the high-symmetry points along the k-point path specified in the KPOINTS file that are closest, in terms of k-point index, to the k-point at which the VBM(CBM) occurs.
